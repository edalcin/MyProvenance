...
Cadastro por **Conta** (isolado entre usuários — não é mais global), reutilizável entre Registros da mesma conta. Sem Conta, vive só na sessão anônima do navegador — ver `CONTEXT.md` e ADR-0009.
