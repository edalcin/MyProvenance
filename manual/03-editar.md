...
<!-- SCREENSHOT: adicione a imagem em manual/img/03-editar-registro.png -->
![Botão Editar no cabeçalho do Registro](img/03-editar-registro.png)

<!-- SCREENSHOT: adicione a imagem em manual/img/03-editar-atividade.png -->
![Formulário de edição de uma Atividade, com o tipo fixo](img/03-editar-atividade.png)
