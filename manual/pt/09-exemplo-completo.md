...
Veja [Criar registro](/como-usar/01-criar-registro). Título: `Ocorrências de Myrcia na Mata Atlântica`.

## Passo 2 — Cadastrar os Agentes

Os três Agentes (`José Silva`, `Instituto de Pesquisas Jardim Botânico do Rio de Janeiro`, `OpenRefine 3.7`, `R 4.3.1`) podem ser criados de antemão em `Agentes`, ou inline durante o preenchimento de cada Atividade, usando `Criar "<nome>"` no seletor — ver [Adicionar Atividade](/como-usar/02-adicionar-atividade).
...
- [Exportar Relatório .md](/como-usar/06-exportar-relatorio-md) para gerar a versão legível com diagrama e tabelas.
- [Exportar JSON](/como-usar/05-exportar-json) para guardar uma cópia completa dos dados.
- Opcionalmente, [Finalizar](/como-usar/04-finalizar) o Registro para travar o histórico documentado.

## Screenshot

![Diagrama completo da linhagem do exemplo, das 5 Atividades](/manual/pt/09-diagrama-completo.png)

![Linha do tempo das Atividades do exemplo](/manual/pt/09-linha-do-tempo.png)
