...
![Botão Finalizar no Registro em Rascunho](/manual/pt/04-botao-finalizar.png)

![Badge Finalizado após a ação](/manual/pt/04-badge-finalizado.png)
...
[Exportar JSON](/como-usar/05-exportar-json)
