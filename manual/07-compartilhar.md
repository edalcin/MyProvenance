...
<!-- SCREENSHOT: adicione a imagem em manual/img/07-dialog-link-publico.png -->
![Diálogo Compartilhar Registro, aba Link público](img/07-dialog-link-publico.png)

<!-- SCREENSHOT: adicione a imagem em manual/img/07-aba-compartilhar-usuario.png -->
![Aba Compartilhar com usuário, com campo de nome de usuário e seletor de permissão](img/07-aba-compartilhar-usuario.png)

<!-- SCREENSHOT: adicione a imagem em manual/img/07-lista-acessos.png -->
![Lista Quem tem acesso com os papéis de cada pessoa](img/07-lista-acessos.png)
...
[Excluir registro](08-excluir-registro.md)
